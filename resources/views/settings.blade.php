...
@section('content')
	...
	<div class="py-1 5 px-2 mb-4 text-sm w-full rounded-md bg-red text-white">
		<div class="flex justify-between items-center">
			<span>
				<strong class="mr-1">{{ $cookieByte::getCpTranslation('cookie_byte') }}</strong>
				{{ $cookieByte::getCpTranslation('licensing_warning') }}
			</span>
			<div class="flex flex-shrink-0">
				<a href="https://statamic.com/addons/dryven/cookie-byte" class="text-2xs text-white hover:text-yellow flex items-center" aria-label="{{ $cookieByte::getCpTranslation('licensing_buy_button') }}">
